...
public class TextShakeEffect : MonoBehaviour
{
	...
	[SerializeField] float shakeMagnitude = 1f; // Magnitude of the shake
	[SerializeField] float shakeSpeed = 10f;     // Speed of the shake
	...
	public void StartShaking()
	{
		...
		{
			this.SmartWarning("Shaking is already in progress or the word index is out of range.");
		}
	}

	private IEnumerator ShakeWord()
	{
		this.SmartLog("Started shaking!");
		isShaking = true;
		...
		while (isShaking)
		{
			this.SmartLog("Inside of the while loop");
		...
		this.SmartLog("Resseting original verticies state");
		...
		this.SmartLog("Stopped shaking!");
		isShaking = false;
	}

	public void StopShaking()
	{
		this.SmartLog("Shaking was interrupted!");
		isShaking = false;
	}
